...
<script>
	$(function(){
		...
		$('#maintainStatCode2').hide();
		$('label[for=maintainStatCode2]').hide();
		
		$('#maintainStatCode3').hide();
		$('label[for=maintainStatCode3]').hide();
	});
</script>
<style type="text/css">
	body {
    ...
    <table cellSpacing="1" cellPadding="5" width="880" align="center" bgColor="#eeeeee" style="border:1px solid #8ba7e3" border="0">
		...
		<tr>
			<td class="ta_01" style="WIDTH: 100%" align="center" colSpan="4">
				<input type="button" name="BT_Submit" value="保存"  style="font-size:12px; color:black; height=22;width=55" onclick="auditInfoRefuseButton()">
				<font face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>

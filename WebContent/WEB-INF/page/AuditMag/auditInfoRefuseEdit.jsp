    ...
    <table cellSpacing="1" cellPadding="5" width="580" align="center" bgColor="#eeeeee" style="border:1px solid #8ba7e3" border="0">
		<tr>
			<td class="ta_01" align="center" colSpan="4" background="${pageContext.request.contextPath }/images/b-info.gif">
				<font face="宋体" size="2"><strong>编辑审核未通过故障信息</strong></font>
			</td>
		</tr>
	    <tr>
		...
		<tr>
			...
			<td align="center" bgColor="#f5fafe" class="ta_01">审核通过日期：</td>
			<td class="ta_01" bgColor="#ffffff">
				<input class="Wdate" type="text" size="20" value="2013-12-23" disabled="disabled">
			</td>
		</tr>
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">
				<input type="radio" name="test2" value="通过">通过&nbsp;&nbsp;&nbsp;
				<input type="radio" name="test2" value="驳回" checked="checked">驳回&nbsp;&nbsp;&nbsp;
			</td>
		</tr>
		<tr>
			<td align="center" bgColor="#f5fafe" class="ta_01">维护状态：</td>
			<td class="ta_01" bgColor="#ffffff">
				<input type="radio" name="test" value="未完成" checked="checked">未完成&nbsp;&nbsp;
				<input type="radio" name="test" value="已完成">已完成&nbsp;&nbsp;
			</td>
			<td align="center" bgColor="#f5fafe" class="ta_01">优先级别：</td>
			<td class="ta_01" bgColor="#ffffff">
	       		<input type="radio" name="rank" value="C">高&nbsp;&nbsp;&nbsp;&nbsp;
	       		<input type="radio" name="rank" value="C">中&nbsp;&nbsp;&nbsp;&nbsp;

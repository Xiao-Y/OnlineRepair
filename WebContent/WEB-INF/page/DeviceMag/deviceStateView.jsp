...
<form name="Form1" method="post">
    ...
    <table cellSpacing="1" cellPadding="5" width="580" align="center" bgColor="#eeeeee" style="border:1px solid #8ba7e3" border="0">
		...
		<tr>
			<td align="right" bgColor="#f5fafe" class="ta_01">上次检修日期：</td>
	       	<td class="ta_01" bgColor="#ffffff">
				<s:textfield name="lastTime" id="lastTime" maxlength="25" size="20" readOnly="false"/>
	       	</td>
		    <td align="right" bgColor="#f5fafe" class="ta_01">下次检修日期：</td>
			<td class="ta_01" bgColor="#ffffff">
		...
		<tr>
			<td align="right" bgColor="#f5fafe" class="ta_01">安装日期：</td>
			<td class="ta_01" bgColor="#ffffff">

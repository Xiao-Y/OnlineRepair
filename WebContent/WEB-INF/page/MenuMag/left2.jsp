			...
			<td vAlign="top" height="100%">
				...
				<div class="qx_list" id="auditMagChild">
					<table cellSpacing="0" cellPadding="0" width="99%" border="0">
						...
						<tr height="25">
							<td class="box05" onmouseover="backgroundColorChange(this,'#AAAAAA');" onmouseout="backgroundColorChange(this,'');">
								<a class="cl_01" onclick="linkcolorchange(this)" href='${pageContext.request.contextPath }/AuditMag/auditInfoAction_auditInfoPassList.action' target="main">
									<span>审核通过</span>
								</a>
							</td>
						</tr>
						<tr height="25">
							<td class="box05" onmouseover="backgroundColorChange(this,'#AAAAAA');" onmouseout="backgroundColorChange(this,'');">
								<a class="cl_01" onclick="linkcolorchange(this)" href='${pageContext.request.contextPath }/AuditMag/auditInfoAction_auditInfoRefuseList.action' target="main">
									<span>审核未通过</span>
								</a>
							</td>
						</tr>
				...
				<div class="qx_list" id="resourceMagChild">
					<table cellSpacing="0" cellPadding="0" width="99%" border="0">
						...
						<tr height="25">
							<td class="box05" onmouseover="backgroundColorChange(this,'#AAAAAA');" onmouseout="backgroundColorChange(this,'');">
								<a class="cl_01" onclick="linkcolorchange(this)" href='${pageContext.request.contextPath }/ResourceMag/menuInitAction_menuInit.action' target="main">
									<span>初始化菜单</span>
								</a>
							</td>
						</tr>

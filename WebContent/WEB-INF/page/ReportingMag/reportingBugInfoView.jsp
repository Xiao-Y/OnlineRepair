...
<form name="Form1" method="post">
    ...
    <table cellSpacing="1" cellPadding="5" width="580" align="center" bgColor="#eeeeee" style="border:1px solid #8ba7e3" border="0">
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">
				<input class="" type="text" size="20" id="phone" name="phone" value="admin" disabled="disabled">
			</td>
	        <td align="center" bgColor="#f5fafe" class="ta_01">维护人联系方式：</td>
			<td class="ta_01" bgColor="#ffffff">
				<input class="" type="text" size="20" id="phone" name="phone" value="12322133234" disabled="disabled">
			</td>
		</tr>
		...
		<tr>
			...
			<td class="ta_01" bgColor="#ffffff">
				<input type="text" size="20" value="已完成" disabled="disabled">
			</td>
		</tr>
		<tr>
			<td align="center" bgColor="#f5fafe" class="ta_01">审核状态：</td>
			<td class="ta_01" bgColor="#ffffff">
				<input type="text" size="20" value="已通过" disabled="disabled">
			</td>
			<td align="center" bgColor="#f5fafe" class="ta_01">评价状态：</td>
			<td class="ta_01" bgColor="#ffffff">
				<input type="text" size="20" value="未评价" disabled="disabled">
			</td>
		</tr>

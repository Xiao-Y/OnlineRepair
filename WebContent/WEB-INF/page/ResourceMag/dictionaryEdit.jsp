...
<table cellSpacing="1" id="tableNew" cellPadding="0" width="100%" align="center" bgColor="#f5fafe" border="0">
	<tr>
		<td>
					...
					<s:iterator value="%{#request.systemList}">
						<tr>
							...
							<td class="ta_01" align="center" width="20%">
								<a href="javascript:remove('<s:property value="%{ddlCode}"/>','<s:property value="%{seqID}"/>')" id="${seqID }">

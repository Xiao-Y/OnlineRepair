...
用户填写申报信息，后台添加审核记录-->
	...
	|								|			
	|								|----->审核通过（不修改审核状态）：------>已处理：修改维护人员uuid、添加新的完成时间，维护状态设置为“已处理”，修改审核状态为“审核通过”			
	|								|								|
	|								|								|----->待处理：修改维护人员uuid、清空完成时间、维护状态设为“待处理”，修改审核状态为“审核通过”
	|								|
	|								|----->驳回：删除评价记录、清空审核表中维护人员uuid、清空完成时间、清空驳回原因，维护状态设为“未处理”	，修改审核状态为“驳回”		
	|										
	|--->管理员在未通过审核列表中进行修改------>待审核：修改审核状态为“待审核”										
										|	
										|-->审核通过：添加评价记录、清空驳回原因、维护状态设为“待维护”，添加维护人员uuid，添加审核通过时间，添加审核人uuid	
										|
										|-->驳回：不作处理	
